...
export const schemas = {
  product: z.object({
    ...
    hsnCode: z.string()
      .regex(/^\d{8}$/, 'HSN Code must be exactly 8 numeric digits')
...
export type ProductFormData = z.infer<typeof schemas.product>;
export type ContactFormData = z.infer<typeof schemas.contact>;
export type QuotationFormData = z.infer<typeof schemas.quotation>;